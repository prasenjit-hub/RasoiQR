-- =====================================================
-- Migration 011 — Fix ambiguous order_number in
--                 customer_create_order
-- =====================================================
-- The function declares RETURNS TABLE (..., order_number TEXT)
-- which creates an output parameter that shadows the
-- orders.order_number column. The RETURNING clause becomes
-- ambiguous: does "order_number" mean the table column or
-- the function's output parameter?
--
